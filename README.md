...
1. Mia Sejdinović (GitHub username: miasejdinovic, zaduženje: JavaScript)
2. Minela Avdić (GitHub username: minelaavdic-create, zaduženje: HTML + struktura)
3. Mirnesa Kadrić (GitHub username: MirnesaK, zaduženje: CSS + dizajn)
